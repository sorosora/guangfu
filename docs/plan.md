...
### 2.1 基礎 UI 元件設定
- [ ] 安裝 shadcn/ui Button 元件：`npx shadcn@latest add button`
- [ ] 安裝 shadcn/ui Toast 元件：`npx shadcn@latest add toast`
- [ ] 建立全域樣式檔案
- [ ] 設定響應式布局
- [ ] 建立載入中元件
...
### 4.2 Python 圖磚生成腳本
- [ ] 建立 `generate_tiles.py` 腳本
- [ ] 安裝必要的 Python 套件：`pip install redis pillow numpy boto3`
  - [ ] redis
  - [ ] pillow
  - [ ] numpy
  - [ ] boto3
